 ...
 *
 */
public class BuildUnorderedListTest {
  ...
  BuildUnorderedList b1, b2, b3, b4, b5;
  LinkedList<Line> l1, l2, l3, l4, l5;
  ListIterator<Line> i1, i2, i3, i4, i5;
  // listTuple, list of listTuple, and doculist
  ListTuple lt1, lt2, lt3, lt4, lt5, lt6, lt7, lt8, lt9, lt10, lt11;
  List<ListTuple> ll1, ll2, ll3, ll4, ll5, ll6, ll7, ll8, ll9;
  DocuList d1, d2, d3, d4, d5, d6, d7, d8, d9, d10;
  ...
  public void setUp() throws Exception {
    ...
    this.b1 = new BuildUnorderedList(this.nl5, this.i1);
    this.b2 = new BuildUnorderedList(this.nl5, this.i2);
    this.b3 = new BuildUnorderedList(this.nl5, this.i3);
    this.b4 = new BuildUnorderedList(this.nl4, this.i4);
    this.b5 = new BuildUnorderedList(this.nl6, this.i5);
    ...
    this.ll9 = new LinkedList<ListTuple>();
    ...
    this.lt1 = new ListTuple(this.a5, this.d1);
    this.ll1.add(this.lt1);
    this.d2 = new UnorderedDocuList(this.ll1);
    // creating for builder2
    this.lt2 = new ListTuple(this.a4, this.d1);
    this.ll2.add(this.lt2);
    this.d3 = new UnorderedDocuList(this.ll2);
    this.lt3 = new ListTuple(this.a5, this.d3);
    this.ll3.add(this.lt3);
    this.d4 = new UnorderedDocuList(this.ll3);
    // creating for builder3
    this.lt4 = new ListTuple(this.a6, this.d1);
    this.ll4.add(this.lt4);
    this.ll4.add(this.lt4);
    this.d5 = new UnorderedDocuList(this.ll4);
    this.lt5 = new ListTuple(this.a2, this.d1);
    this.lt6 = new ListTuple(this.a2, this.d5);
    this.ll5.add(this.lt5);
    this.ll5.add(this.lt6);
    this.d6 = new OrderedDocuList(this.ll5);
    this.lt7 = new ListTuple(this.a5, this.d6);
    this.ll6.add(this.lt7);
    this.d7 = new UnorderedDocuList(this.ll6);
    // creating for builder4
    this.lt8 = new ListTuple(this.a3, this.d1);
    this.ll7.add(this.lt8);
    this.d8 = new OrderedDocuList(this.ll7);
    this.lt9 = new ListTuple(this.a4, this.d8);
    this.lt10 = new ListTuple(this.a4, this.d1);
    this.ll8.add(this.lt9);
    this.ll8.add(this.lt10);
    this.d9 = new UnorderedDocuList(this.ll8);
    // creating for builder5
    this.lt11 = new ListTuple(this.a6, this.d1);
    this.ll9.add(this.lt11);
    this.ll9.add(this.lt11);
    this.ll9.add(this.lt11);
    this.d10 = new UnorderedDocuList(this.ll9);
  }
  ...
  public void testBuild() {
    Assert.assertEquals(this.b1.build(), this.d2);
    Assert.assertEquals(this.b2.build(), this.d4);
    Assert.assertEquals(this.b3.build(), this.d7);
    Assert.assertEquals(this.b4.build(), this.d9);
    Assert.assertEquals(this.b5.build(), this.d10);
  }
